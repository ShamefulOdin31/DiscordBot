attacks = ["Bunny Hop: During attack the attackers may only move their drone by jumping from start till end.",
...
defenses = ["Defend the lord: While defending 1 must go as the lord tachanka him self and the other 4 are supposed to defend him at all cost.",
...
anys = ["Iron Silence: Iron sights and suppressors only",
